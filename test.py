...
def extend_cfg(cfg):
    ...
    cfg.DATALOADER.TEST.NUM_FRAMES = 6
    cfg.DATALOADER.TEST.TESTING = True
    ...
    cfg.TRAIN.USE_VISION_CONTEXT = True
    cfg.TRAIN.USE_PREFUSION = True
    cfg.TRAIN.USE_TEXT_GUIDE = True
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('ReferFormer inference script', parents=[args_setting.get_args_parser()])
